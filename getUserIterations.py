...
def returnDataToJs():
    ...
    if(iterationsList):
        ...
        output['new_iterations'] = {'Разработка дополнительных модулей для сервиса записи на проектное обучение': {'Анализ': {'Начало итерации': '2022-05-15', 'Конец итерации': '2022-06-01', 'ID итерации': '15197', 'Вы оценили': 6, 'Вас оценили': 6, 'Колличество студентов': 6}, 'Разработка': {'Начало итерации': '2022-05-29', 'Конец итерации': '2022-06-08', 'ID итерации': '17391', 'Вы оценили': 6, 'Вас оценили': 6, 'Колличество студентов': 6}, 'Тестирование': {'Начало итерации': '2022-06-05', 'Конец итерации': '2022-06-15', 'ID итерации': '17392', 'Вы оценили': 6, 'Вас оценили': 6, 'Колличество студентов': 6}, 'Презентация': {'Начало итерации': '2022-06-12', 'Конец итерации': '2022-06-18', 'ID итерации': '17393', 'Вы оценили': 6, 'Вас оценили': 6, 'Колличество студентов': 6}, 'Представление': {'Начало итерации': '2022-08-12', 'Конец итерации': '2022-09-18', 'ID итерации': '17398', 'Вы оценили': 0, 'Вас оценили': 4, 'Колличество студентов': 6}, 'Защита перед ректором': {'Начало итерации': '2022-08-12', 'Конец итерации': '2022-09-18', 'ID итерации': '17398', 'Вы оценили': 0, 'Вас оценили': 4, 'Колличество студентов': 6}}}
    else:
